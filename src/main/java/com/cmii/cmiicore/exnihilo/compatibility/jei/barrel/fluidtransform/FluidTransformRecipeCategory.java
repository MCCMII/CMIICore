package com.cmii.cmiicore.exnihilo.compatibility.jei.barrel.fluidtransform;
...
public class FluidTransformRecipeCategory implements IRecipeCategory<FluidTransformRecipe> {
    public static final String UID = "cmiicore:fluid_transform";
    ...
    public FluidTransformRecipeCategory(IGuiHelper guiHelper) {
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull FluidTransformRecipe recipeWrapper, @Nonnull IIngredients ingredients) {
        ...
        recipeLayout.getItemStacks().init(3, true, 65, 19);

        recipeLayout.getItemStacks().set(0, ingredients.getInputs(FluidStack.class).get(0));
