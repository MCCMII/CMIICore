package com.cmii.cmiicore.exnihilo.compatibility.jei.hammer;
...
import com.cmii.cmiicore.exnihilo.util.StringUtils;
...
public class HammerRecipeCategory implements IRecipeCategory<HammerRecipe> {
    public static final String UID = "cmiicore:hammer";
