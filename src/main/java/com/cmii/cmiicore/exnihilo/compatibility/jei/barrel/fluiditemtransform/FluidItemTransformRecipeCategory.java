...
public class FluidItemTransformRecipeCategory implements IRecipeCategory<FluidItemTransformRecipe> {
    ...
    public void setRecipe(@Nonnull IRecipeLayout recipeLayout, @Nonnull FluidItemTransformRecipe recipeWrapper, @Nonnull IIngredients ingredients) {
        ...
        recipeLayout.getItemStacks().init(2, false, 110, 10);
        recipeLayout.getItemStacks().init(3, true, 45, 19);

        recipeLayout.getItemStacks().set(0, new ItemStack(ModBlocks.barrel));
        recipeLayout.getItemStacks().set(1, recipeWrapper.getInputs().get(1));
        recipeLayout.getItemStacks().set(2, recipeWrapper.getOutput());
        recipeLayout.getItemStacks().set(3, recipeWrapper.getInputs().get(0));
