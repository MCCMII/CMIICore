...
import com.cmii.cmiicore.exnihilo.api.registries.IBarrelLiquidBlacklistRegistry;
...
public class BarrelLiquidBlacklistRegistry extends BaseRegistryMap<Integer, List<String>> implements IBarrelLiquidBlacklistRegistry {
    ...
    protected void registerEntriesFromJSON(FileReader fr) {
        Map<Integer, List<String>> loaded = gson.fromJson(fr, new TypeToken<Map<Integer, List<String>>>() {}.getType());
