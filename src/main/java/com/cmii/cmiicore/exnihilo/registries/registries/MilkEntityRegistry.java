...
public class MilkEntityRegistry extends BaseRegistryList<Milkable> implements com.cmii.cmiicore.exnihilo.api.registries.IMilkEntityRegistry {
    ...
    @Nullable
    public Milkable getMilkable(@Nullable Entity entityOnTop) {
    ...
    public void registerEntriesFromJSON(FileReader fr) {
        List<Milkable> gsonInput = gson.fromJson(fr, new TypeToken<List<Milkable>>() {}.getType());
